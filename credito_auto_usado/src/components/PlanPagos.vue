    ...
    methods: {
      hallarflujos(){
        ...
        crearflujo(){    
            ...
            let diasAux = new Date(fechaAux.getFullYear(),fechaAux.getMonth(),0).getDate()
            //dias del mes
         ...
         { //flujo auxiliar
          ...
          let segurodesFC = ISFC * d;

          let segurobienFC =  ISFC * m;

          let cuotaFC = (this.PrecioVehiculo-this.CuotaInicial) * (I /(1-Math.pow( 1 + I,-1 * this.cuotas.value) ));
